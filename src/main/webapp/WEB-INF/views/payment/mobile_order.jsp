...
<body>
    <div class="wrap">
        ...
        <form name="order_info" method="post" action="${pageContext.request.contextPath }/MobilePaymentProcess" >
            ...
            <input type="hidden"   name="Ret_URL"         value="http://.../spl_test/sample/pay/jsp_kcp_api_pay_sample/mobile_sample/order_mobile.jsp" />
