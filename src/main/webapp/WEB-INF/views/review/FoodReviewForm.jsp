...
<%-- 	<script src="${pageContext.request.contextPath }/resources/assets/vendor/tinymce/tinymce.min.js"></script><!--  -->
 --%>
	...
	function writeReview(rvfdcode,fname){
		window.open('${pageContext.request.contextPath }/fdreviewForm?refdcode='+refdcode+"&fname="+fname+"&rvfdthcode="+rvfdthcode,'reviewFormPage',"width=750,heigh=400, top=100, left=500");
	}
