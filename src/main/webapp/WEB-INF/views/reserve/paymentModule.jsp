...
<%
    ...
    */
    ...
    String site_cd              = f_get_parm( request.getParameter( "T0000"  )); // 사이트코드
    // 인증서정보(직렬화)
...
<body oncontextmenu="return false;">
    <div class="wrap">
        ...
        <div id="skipCont" class="contents">
            ...
            <ul class="list-btn-2">
                <li class="pc-only-show"><a href="${pageContext.request.contextPath }/reservePage" class="btn-type-3 pc-wd-2">처음으로</a></li>
            </ul>
        </div>
