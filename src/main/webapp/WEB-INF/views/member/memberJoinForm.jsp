						...
						<form class="row g-3"
							...
							<div class="col-md-6">
								<label for="inputMid" class="form-label">아이디</label> <span
									class="small" id=idCheckMsg>중복확인 메세지</span> 
							...
							<div class="col-md-6">
								<label for="inputMPhone" class="form-label">휴대폰번호</label> <input
									type="text" name="mphone" class="form-control" id="inputMbirth">
							</div>
